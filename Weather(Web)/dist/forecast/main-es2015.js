...
let CurrentlyComponent = class CurrentlyComponent {
    constructor(resultsService, searchService) {
...
CurrentlyComponent.ctorParameters = () => [
...
let FavourComponent = class FavourComponent {
    constructor(router, searchService, resultsService) {
        this.router = router;
        this.searchService = searchService;
        this.resultsService = resultsService;
    ...
    getData(entry) {
        this.searchService.getImgLink(entry.state + ' State ' + 'Seal').subscribe(list => {
            ...
            this.searchService.getData(entry).subscribe(list => {
...
FavourComponent.ctorParameters = () => [
...
class Location {
    constructor(street, city, state, lat, lon, flag) {
        this.street = street;
        this.city = city;
        this.state = state;
        this.lat = lat;
...
let ResultsComponent = class ResultsComponent {
    constructor(searchService, resultsService, router) {
        this.searchService = searchService;
        this.resultsService = resultsService;
        this.router = router;
        this.status = "";
...
let SearchService = class SearchService {
    ...
    getData(entry) {
        ...
        let options = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('street', entry.street).set('city', this.city).
    ...
    getDetails(time) {
        let options = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('lat', this.lat).set('lon', this.lon).set('time', time) };
        return this.http.get(this.dataUrl, options);
    }
    getState() {
        return this.state;
    ...
    getImgLink(searchParam) {
        let options = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('q', searchParam) };
    ...
    getPredictions(txt) {
        let options = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('input', txt) };
...
let SearchComponent = class SearchComponent {
    ...
    getData() {
        this.searchService.getImgLink(this.location.state + ' State ' + 'Seal').subscribe(list => {
            this.searchService.setImgLink(list['items'][0]['link']);
            this.searchService.getData(this.location).subscribe(list => {
                this.searchService.setStatus('Success');
...
let WeeklyComponent = class WeeklyComponent {
    constructor(dialog, resultsService, searchService) {
        this.dialog = dialog;
        this.resultsService = resultsService;
        this.searchService = searchService;
        this.data = { data: [] };
    ...
    ngOnInit() {
        ...
        ;
        let chart = new _assets_canvasjs_min__WEBPACK_IMPORTED_MODULE_4__["Chart"]("chartContainer", {
